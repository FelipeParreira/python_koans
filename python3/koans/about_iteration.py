...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce iterates over an iterable applying a function to the current element and the previous result. Initially the first result can be the first item (the process starts with the second item) or it can be a given initial value.
